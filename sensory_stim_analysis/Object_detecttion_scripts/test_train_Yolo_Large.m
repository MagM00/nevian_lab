...
%% This script will train a larg Yolo network.
% It seems that it works worse than the tiny version.
clc
clear
...
pretrainedDetector = yolov2ObjectDetector("darknet19-coco"); % 'darknet19-coco'
...
% save detector
detector_filename = ['detector_v', (v), 'yolo_Large.mat'];
